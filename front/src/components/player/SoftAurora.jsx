...
function SoftAurora({
  ...
  useEffect(() => {
    ...
    programRef.current.uniforms.uNoiseFreq.value = noiseFrequency;
    programRef.current.uniforms.uNoiseAmp.value = noiseAmplitude;
    programRef.current.uniforms.uBandHeight.value = bandHeight;
    programRef.current.uniforms.uBandSpread.value = bandSpread;
    programRef.current.uniforms.uOctaveDecay.value = octaveDecay;
    programRef.current.uniforms.uLayerOffset.value = layerOffset;
    programRef.current.uniforms.uColorSpeed.value = colorSpeed;
    programRef.current.uniforms.uMouseInfluence.value = mouseInfluence;
    programRef.current.uniforms.uEnableMouse.value = enableMouseInteraction;
  }, [
    speed,
    scale,
    brightness,
