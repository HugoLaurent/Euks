...
export class TrackSchema extends BaseModel {
  static $columns = ['audioFilePath', 'bpm', 'coverImagePath', 'createdAt', 'durationSeconds', 'id', 'listenCount', 'musicalKeyId', 'priceCents', 'title', 'updatedAt', 'waveFilePath', 'zipFilePath'] as const
